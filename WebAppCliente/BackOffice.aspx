...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <legend style="text-align:center; margin-top:100px; font-size:40px">Back-Office Tools</legend>
             ...
             <fieldset class="field_set" style="background-color:#FCDA00">
               ...
               <asp:Button class="btn_backoffice" ID="Button_formulas" runat="server" Text="Manage Formulas" style="margin-right:50px; margin-top:40px; margin-bottom:70px"  Width="200px"  Height ="200px"/>
